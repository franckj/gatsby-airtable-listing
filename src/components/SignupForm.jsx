      ...
      <div className="flex flex-wrap lg:justify-between lg:items-center">
        ...
        <div className="flex w-full md:w-1/2 lg:w-auto">
          <input
            ...
            className="flex-1 lg:w-34 rounded-l-lg bg-white dark:bg-gray-900 placeholder-blue-800 dark:placeholder-blue-600 text-blue-800 dark:text-blue-400 px-4 py-1 border border-blue-700 dark:border-blue-400 appearance-none rounded-left text-lg leading-loose focus:outline-none focus:shadow-outline"
            maxLength="40"
            name="email"
